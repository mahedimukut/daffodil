...
export const ContactFormSubmissionBookings = ({
  name,
  email,
  mobile,
  moveinDate,
    ...
    <Html>
      ...
      <Body style={bodyStyle}>
        <Container style={containerStyle}>
          ...
          {/* Header Section */}
          <Text style={headerStyle}>Booking information</Text>
          ...
          <table style={detailsTableStyle}>
            <tbody>
              ...
              {/* Move in date */}
              <tr style={detailRowStyle}>
                <td style={labelStyle}>Move in date:</td>
                <td style={valueStyle}>{moveinDate}</td>
              </tr>
